...
import 'package:khatasystem/features/reports/statement/customer_ledger_report/model/customer_ledger_report_model.dart';
...
class CustomerSubReportPage extends ConsumerStatefulWidget {
  final CustomerLedgerModel tblData;
  final List<Map<dynamic, dynamic>> dropDownList;
  final String selectedGroup;
  final String ledgerName;
  final String branchName;
  const CustomerSubReportPage({Key? key,required this.tblData, required this.dropDownList, required this.selectedGroup, required this.ledgerName,required this.branchName}) : super(key: key);

  @override
  ConsumerState<CustomerSubReportPage> createState() => _SubReportPageState();
}

class _SubReportPageState extends ConsumerState<CustomerSubReportPage> {
